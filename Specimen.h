...
// defocus blur, intensity scaling, and shot noise pipeline common to all
// simulated specimens. The result is added to the existing contents of
// buffer, which the caller must initialize (e.g., with a dark frame). rng is
// used for the noise (and may also be used by drawContent).
